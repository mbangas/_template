---
name: doc-api
description: A skill that provides API documentation capabilities, enabling agents to analyze API endpoint code and generate comprehensive OpenAPI specifications for effective API design and communication.
allowed-tools: shell
---
