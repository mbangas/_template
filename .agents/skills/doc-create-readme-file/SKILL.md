---
name: doc-create-readme-file
description: Guide for creating a comprehensive README.md file that effectively communicates the purpose, usage, and contribution guidelines of the project to developers.
allowed-tools: shell
---
