---
name: rules-generate-unit-tests
description: A skill that generates focused unit tests for selected functions or methods, ensuring thorough validation of their behavior.
---

# Rules for Generating Unit Tests

Unit tests are essential for validating the behavior of individual functions or methods in isolation. This skill focuses on generating high-quality, focused unit tests that cover core functionality, input validation, error handling, and side effects (if applicable) for a specific function or method. By following these rules, agents can create tests that provide confidence in the correctness of the code and help catch regressions in the future.
